...
import ValidationErrors from "@/Components/ValidationsError";
    ...
    const connectWallet = async () => {
        try {
            ...
            if (!window.ethereum?.isMetaMask) {
                alert('Please use MetaMask (disable Phantom EVM)')
                return
            }
            ...
            const { data } = await axios.post('/wallet/nonce', {
                address,
                chain: 'evm',
            })
            ...
            const res = await axios.post('/wallet/verify', {
                address,
                signature,
                chain: 'evm',
                message,
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="space-y-4 pt-2">
                                <PrimaryButton
                                    ...
                                    className="w-full justify-center !rounded-xl !py-3.5 bg-indigo-600 hover:bg-indigo-700 transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)]">
                                ...
                                <div className="relative flex py-2 items-center">
                                    ...
                                    <span className="flex-shrink-0 mx-4 text-gray-600 text-xs uppercase tracking-wider">
                                        Or continue with
                                    </span>
                                    <div className="flex-grow border-t border-gray-800"></div>
                                </div>
    ...
    `                               }
                                    >
                                        ...
                                        >
                                            ...
                                            {loadingWallet ? "Connecting..." : "Sign in with Wallet"}
                                        </span>
                                    </PrimaryButton>
