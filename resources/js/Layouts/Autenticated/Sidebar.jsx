...
export default function Sidebar({ isSidebarOpen, isDesktopSidebarOpen = true }) {
    return (
            ...
            <div className="flex flex-col p-[30px] pr-0 overflow-y-auto h-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                ...
                <div className="links flex flex-col mt-[60px] h-full gap-[50px]">
                    ...
                    <div>
                        ...
                        <Link href="/prototype/subscriptionPlan" className="flex items-center gap-4 text-gray-400 hover:text-white transition-all mb-8">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
