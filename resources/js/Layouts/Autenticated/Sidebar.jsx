export default function Sidebar({ isSidebarOpen }) {
    return (
        <aside className={`fixed z-50 w-[300px] h-full bg-[#0a0a0a] border-r border-[#1F1F1F] transition-transform duration-300 ease-in-out lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>

            <div className="flex flex-col p-[30px] pr-0 overflow-y-auto h-full scrollbar-hide">
                <a href="/">
                ...
                <div className="links flex flex-col mt-[60px] h-full gap-[50px]">
                    ...
                    <div>
                        ...
                        <a href="#!" className="flex items-center gap-4 text-gray-400 hover:text-white transition-all mb-8">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#!" className="flex items-center gap-4 text-gray-400 hover:text-white transition-all mb-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    {/* Others */}
                    <div>
                        <div className="text-gray-500 text-xs font-medium mb-6 uppercase tracking-wider">Others</div>
                        <a href="pricing.html" className="flex items-center gap-4 text-gray-400 hover:text-white transition-all mb-8">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                        ...
                        <a href="sign_in.html" className="flex items-center gap-4 text-gray-400 hover:text-white transition-all mb-0">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd"
                    ...
                    <div className="mt-auto pr-[30px]">
                        <div className="p-5 bg-[#181818] rounded-[20px] border border-[#262626]">
                            <img src="/icons/ic_star-rounded.svg" alt="" />
                                ...
                                <div className="rounded-full w-full h-[6px] bg-[#262626]">
